    ...
    return {
        ...
        signBaseURL: function () {
            var getUrl = window.location,
                baseUrl = getUrl .protocol + "//" + getUrl.host + "/" + 'templates/porn';
            return baseUrl;
        },
        ...
        signValidation: function () {
                ...
                $('.sign-in').validate(
                    {
                        invalidHandler:
                            function() {
                                ...
                                $('#page-content').addClass('animated shake');
                                setTimeout(function(){$('#page-content').removeClass('animated shake')}, 1500);
			...
			if($('.sign-up').length && $(window).width() >= 1024){
        ...
        signSettingHeight: function () {
            $('#page-content').css('min-height',$(window).outerHeight());
        },
